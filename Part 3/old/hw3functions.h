...
//Returns a word with extra white-spaces stripped out
...
//This function is called for every word in the file. The words are passed in along with a map filled with
//the common words. If the word is common, then an empty string is returned. Otherwise the original word
//is returned.
